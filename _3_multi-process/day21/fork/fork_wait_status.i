...
# 2 "fork_wait_status.c" 2


# 3 "fork_wait_status.c"
int main(int argc,char* argv[])
{
    if(!fork())
    {
        ...
        if(
# 13 "fork_wait_status.c" 3 4
          (((
# 13 "fork_wait_status.c"
          status
# 13 "fork_wait_status.c" 3 4
          ) & 0x7f) == 0)
# 13 "fork_wait_status.c"
...
# 15 "fork_wait_status.c" 3 4
                                         (((
# 15 "fork_wait_status.c"
                                         status
# 15 "fork_wait_status.c" 3 4
                                         ) & 0xff00) >> 8)
# 15 "fork_wait_status.c"
