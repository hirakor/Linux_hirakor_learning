...
# 2 "pthread_cond_timedwait.c" 2

# 2 "pthread_cond_timedwait.c"
typedef struct{
    pthread_cond_t cond;
...
int main()
{
    int ret;
    thData threadinfo;
    ret=pthread_cond_init(&threadinfo.cond,
# 19 "pthread_cond_timedwait.c" 3 4
                                          ((void *)0)
# 19 "pthread_cond_timedwait.c"
                                              );
    if(ret!=0)
    {
    ...
    pthread_mutex_init(&threadinfo.mutex,
# 25 "pthread_cond_timedwait.c" 3 4
                                        ((void *)0)
# 25 "pthread_cond_timedwait.c"
                                            );
    pthread_t pthid;
    pthread_create(&pthid,
# 27 "pthread_cond_timedwait.c" 3 4
                         ((void *)0)
# 27 "pthread_cond_timedwait.c"
                             ,threadfunc,&threadinfo);
    sleep(1);
    pthread_cond_signal(&threadinfo.cond);
    pthread_join(pthid,
# 30 "pthread_cond_timedwait.c" 3 4
                      ((void *)0)
# 30 "pthread_cond_timedwait.c"
                          );
    return 0;
}
